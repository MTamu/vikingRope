import { c as create_ssr_component, s as setContext, v as validate_component, b as compute_rest_props, h as spread, k as escape_attribute_value, i as escape_object, q as getContext, l as subscribe, d as add_attribute, o as escape } from "./index2.js";
...
const Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  setContext("ctx", ctx);
  let frameClass = classNames(defaultClass, "divide-gray-200 dark:divide-gray-700", "border-gray-200 dark:border-gray-700", "rounded-t-xl", $$props.class);
...
const AccordionItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<h2${add_attribute("aria-expanded", open, 0)} class="${"group"}"><button type="${"button"}"${add_attribute("class", buttonClass, 0)}>${slots.header ? slots.header({}) : ``}
...
const Contacts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="${"contacts"}" class="${escape(bgColor, true) + " mt-0"}"><div class="${"mx-auto flex max-w-screen-xl justify-center pt-24 pb-32 md:px-10"}"><div class="${"flex flex-col gap-14 border-l-small border-viking-yellow px-4 text-center md:border-l-medium md:px-10"}"><h3 class="${"font-medium tracking-wide"}">${escape(cmsData.title)}</h3>
			<div class="${"flex flex-col gap-10"}"><div class="${""}"><a class="${"rounded bg-viking-yellow p-2 font-medium tracking-wider"}" href="${"tel:+37065482654"}">${escape(cmsData.phone)}</a></div>
				<div><a class="${"rounded bg-viking-yellow p-2 font-medium tracking-wider"}" href="${"mailto:vikingropeaccess@gmail.com"}">${escape(cmsData.email)}</a></div></div></div></div></section>`;
});
export {
  Accordion as A,
  Contacts as C,
